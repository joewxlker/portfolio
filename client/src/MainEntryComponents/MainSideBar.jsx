...
const SideBar = () => {
            ...
            return (
                <>
                    ...
                    <div>
                        ...
                        {/* <button className='w-75 m-2 btn bg-outline-accent text-light'> Resume </button>s */}
                        <button className='w-75 m-2 btn bg-outline-accent text-light' onClick={e => { e.preventDefault();  window.open('https://github.com/riectivnoodes/portfolio')}}> Github </button>
                        <button className='w-75 m-2 btn bg-outline-accent text-light' onClick={e => { e.preventDefault();  window.open('https://www.linkedin.com/in/joe-walker-89312a22a/')}}> Linkedin </button>
                    </div>
                </>
            );
        }
    ...
    const SettingsContainer = () => {
        if (about) {
            return (
                <div className='Settings-container' onMouseEnter={e => { e.preventDefault(); setAbout(false) }}></div>
            )
        }
    };
