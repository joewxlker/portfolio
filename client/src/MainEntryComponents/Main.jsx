...
import MainCanvasForeGround from './MainCanvasForeGround';
    ...
    render() {
        return (
            <Fragment>
                ...
                <div className='MainFlex flex-column d-flex flex-row justify-content-center align-items-center text-light'>
                    <div className='d-flex flex-row justify-content-center align-items-center flex-wrap'>
                        <div className='Main-welcomeContainer rounded d-flex p-3 flex-column justify-content-center'>
                        ...
                        <div className='Main-welcomeContainer h-50 rounded m-5 d-flex p-3 flex-column justify-content-center align-items-center'>
                            <h1>Welcome</h1>
                            {/* <p>I am currently working towards becoming a full stack web3 developer! <br /> I am based in Perth, Western Australia and accross my 6 month journey through software development have picked up skills in both front-end and back-end development as well as web-3 implementation</p> */}
                        </div>
                    </div>
                </div>
                <SideBar />
                <CanvasShapes />
                <PopupMessenger />
                {/* <MainCanvasForeGround/> */}
                {/* <svg className='Main-background-polygon-small' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.89 356.41">
