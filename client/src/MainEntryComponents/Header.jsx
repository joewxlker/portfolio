    ...
    Links = () => {
        return (
            <>
                ...
                <Link to='/' className=''><h4 className='text-light'>Home</h4></Link>
                <Link to='/' className=''><h4 className='text-light'>About</h4></Link>
    ...
    render() {
        return (
            <header className='header d-flex flex-row justify-content-around align-items-center'>
                <Link to='/' className='headerLogoLeft w-25 h-100 d-flex flex-row justify-content-center align-items-center'>
                    <svg className='Header-Svg-spinner' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.89 356.41">
                        <defs>
                            <style>
                            </style>
                        </defs>
