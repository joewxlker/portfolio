...
import './Projects.css'
import PolygonOverlayInverted from '../MainEntryComponents/PolygonOverlayInverted'
            ...
            <Fragment>
                ...
                <div className='SectionOne-cardsMain w-100 d-flex flex-column justify-content-center align-items-center'>
                    <div className='SectionOne-Cards'>
                        ...
                        <div className='SectionOne-Card'><span className='w-100  d-flex flex-column justify-content-center align-items-center'><h2 className='text-light'>Projects</h2><svg className='SectionOne-Card-Svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.89 356.41">
                            ...
                            <p className='text-light'>Implemented within this source code, Is ethereums Web3 API's. I have been working with said API's for a couple weeks now and so far have managed to implement them in this application. In doing so I have built an even better understanding of java script, react and web3</p>
                        </span></div>

                        <div className='SectionOne-Card'><span className='w-100  d-flex flex-column justify-content-center align-items-center'><h2 className='text-light'>Shopify</h2>
                            <image className='redfoxinu-img' src={redfoxinu} />
                        ...
                        <div className='SectionOne-Card'><span className='w-100 d-flex flex-column justify-content-center align-items-center'><h2 className='text-light'>Red Fox Inu</h2>
                            <image className='redfoxinu-img' src={redfoxinu} />
                            <p className='text-light'></p>
                            <button className=' w-100 mt-2 btn bg-accent Live-Preview-button' onClick={e => { e.preventDefault(); window.open('https://www.redfoxinu.com/') }}>Live Preview</button>
                            <button className='w-100 mt-2 btn bg-light View-Code-button'>View Code</button>
                        ...
                        <div className='SectionOne-Card'><span className='w-100  d-flex flex-column justify-content-center align-items-center'><h2 className='text-light'>Web3 Messenger</h2>
                            <image className='redfoxinu-img' src={redfoxinu} />
                            <p className='text-light'></p>
                            <button className=' w-100 mt-2 btn bg-accent Live-Preview-button' onClick={e => { e.preventDefault(); window.open('https://www.redfoxinu.com/') }}>Live Preview</button>
                            <button className='w-100 mt-2 btn bg-light View-Code-button'>View Code</button>
