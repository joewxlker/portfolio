...
const app = express(); 
const PORT = process.env.PORT || 5000; //Listening on port 5000
...
var wss = "/* enter node end point here */"; //<------------------------------------------
...
var contractAddress = " /* enter deployed contract address here */"; //<-------------------------------------- 
...
const secretKey = "/* enter first wallet secret key here */" //<------------------------------------------
const secretKeyTwo = "/* enter second wallet secret key here */"//<------------------------------------------
const address = "/* enter second wallet address here */"//<------------------------------------------
const addressTwo = "/* enter second wallet address here */"//<------------------------------------------
